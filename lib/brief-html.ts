...
function renderPageHeader(params: {
  ...
  const headerOverlaySvg = `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" style="position:absolute;inset:0;pointer-events:none;opacity:0.18;" preserveAspectRatio="xMidYMid meet">
